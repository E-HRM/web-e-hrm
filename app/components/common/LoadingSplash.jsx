    ...
    >
      ...
      <style jsx>{`
        ...
        .fullscreen {
          ...
          inset: 0;
          background:
            radial-gradient(1200px 600px at 50% -10%, ${brand}0d, transparent 60%),
            radial-gradient(800px 400px at -10% 110%, ${brand}0a, transparent 60%),
            #ffffff;
          z-index: 50;
        }
        .logoWrap {
        ...
        @keyframes spin2 {
          from { transform: scale(0.86) rotate(0deg); }
          to   { transform: scale(0.86) rotate(360deg); }
        }
        @keyframes pulse {
          0%, 100% { transform: scale(1.12); opacity: 0.7; }
