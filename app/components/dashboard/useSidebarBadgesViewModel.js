// app/components/dashboard/useSidebarBadgesViewModel.js
"use client";
...
export default function useSidebarBadgesViewModel(role) {
  ...
  // Kalau role gak punya akses, jangan fetch sama sekali
  const keyCuti = canSee
    ? ApiEndpoints.GetPengajuanCutiMobile({
        status: "pending",
        page: 1,
        perPage: 1,
      })
  ...
  return {
    counts,                    // { cuti, izinJam, tukarHari, sakit, total }
