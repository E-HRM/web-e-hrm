...
export default function EditPeriodeModal({ vm }) {
  return (
    <AppModal
    ...
    >
      <div className='space-y-4'>
        <div className='rounded-2xl border border-blue-100 bg-blue-50 p-4'>
          ...
          >
            Perbarui informasi periode penggajian
          </AppTypography.Text>
          ...
          >
            Sesuaikan bulan, tahun, rentang tanggal, status proses, dan template slip gaji untuk periode ini.
          </AppTypography.Text>
        </div>
