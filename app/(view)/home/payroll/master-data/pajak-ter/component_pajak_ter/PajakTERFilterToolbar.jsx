...
export default function PajakTERFilterToolbar({ searchQuery, setSearchQuery, filterKategori, setFilterKategori, kategoriPajakOptions, reloadData, validating, loading, openCreateModal }) {
  return (
    <AppCard
      rounded='lg'
      ring={false}
      ...
      <div className='flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between'>
        <div className='grid w-full flex-1 grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1fr)_280px]'>
          <AppInput
            ...
            placeholder='Cari kode kategori pajak, tarif, penghasilan, atau periode...'
          ...
          <div className='flex w-full items-center gap-3'>
            ...
            <AppSelect
              ...
              onChange={(value) => setFilterKategori(value)}
              options={kategoriPajakOptions}
              placeholder='Filter kode kategori pajak'
              showSearch
              className='w-full'
