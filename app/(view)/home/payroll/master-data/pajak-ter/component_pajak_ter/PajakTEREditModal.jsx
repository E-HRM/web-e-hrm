...
export default function PajakTEREditModal({ vm }) {
  return (
    <AppModal
      open={vm.isEditModalOpen}
      onClose={vm.closeEditModal}
      title='Edit Tarif Pajak TER'
      footer={null}
      width={720}
    >
      {vm.isPreparingEdit ? (
        <div className='grid min-h-[260px] place-items-center rounded-xl border border-dashed border-gray-200 bg-gray-50 px-6 py-10 text-center'>
