...
const BREADCRUMB_ITEMS = [
  ...
  {
    key: 'tipe-komponen-payroll',
    label: 'Tipe Komponen Payroll',
  },
];

export default function TipeKomponenPayrollHeader() {
  return (
    <div className='mb-8'>
      ...
      >
        Kelola master tipe komponen payroll yang menjadi referensi utama untuk definisi komponen payroll.
      </AppTypography.Text>
    </div>
  );
}
