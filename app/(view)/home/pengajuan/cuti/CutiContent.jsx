...
function StatusTag({ status }) {
  ...
  return (
    <AppTag color={cfg.color} variant="soft" size="sm">
      {cfg.label}
    </AppTag>
  );
}
...
function TextClampCell({ text, expanded, onToggle }) {
  ...
  return (
    <>
      <AppTooltip
        title={!expanded && String(text || "").length > 100 ? text : undefined}
      >
        <span
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <div className="mt-2 text-xs text-gray-500">
              Pola kerja yang dipilih akan diterapkan pada tanggal masuk kerja.
            </div>
          </div>
        </div>
      </div>
...
export default function CutiContent() {
    ...
    return [
        ...
        render: (_, r) => {
          ...
          return (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <MiniField label="Tanggal Cuti" className="lg:col-span-3">
              ...
              <MiniField label="Keterangan" className="lg:col-span-3">
                <div className="bg-gray-50 rounded-lg p-3">
                  <TextClampCell
                    text={r.keterangan}
                    expanded={expKet}
      ...
      },
      {
        ...
        render: (_, r) => {
          if (vm.tab === "pengajuan") {
            return (
              <AppSpace direction="vertical" size="xs" className="w-full">
                <AppButton
                  colors={GREEN_BUTTON}
                  variant="primary"
                  icon={<CheckOutlined />}
          ...
          return (
            <div>
              ...
              <div className="mt-3">
                <Button danger onClick={() => vm.cancelDecision(r.id)}>
                  Cancel
                </Button>
              </div>
            </div>
  ...
  const dataSource = useMemo(
    () => vm.filteredData.map((d) => ({ key: d.id, ...d })),
    [vm.filteredData],
  );
        ...
        <div className="inline-flex items-center gap-3 px-4 py-2">
          ...
          <span
            className={[
              ...
              "h-6 min-w-6 px-2 rounded-full text-xs font-bold",
              toneCls,
            ].join(" ")}
          >
            {count}
    ...
    return [
      {
        key: "pengajuan",
        label: (
          <TabLabel text="Pengajuan" count={counts.pengajuan} tone="warning" />
        ),
      },
      {
        key: "disetujui",
        label: (
          <TabLabel text="Disetujui" count={counts.disetujui} tone="success" />
        ),
      },
      {
        key: "ditolak",
        label: <TabLabel text="Ditolak" count={counts.ditolak} tone="danger" />,
      },
    ];
  }, [counts]);
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Link href="/home/pengajuan/cuti/konfigurasi_cuti">
              <AppButton variant="outline" icon={<SettingOutlined />}>
