  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        onFilter: (val, rec) =>
          String(rec.status_recipient || "").toLowerCase() === String(val),
      },
      {
        title: "Catatan",
        dataIndex: "catatan",
  ...
  return (
    <div className="p-6">
      ...
      <Modal
        ...
        footer={
          <Button onClick={() => setOpenDetail(false)} type="primary">
            Tutup
          </Button>
        }
        ...
        <div className="space-y-2">
          <div>
            ...
            <div className="text-sm text-slate-500">
              {detailRow?.user?.departement?.nama_departement || "-"}
            </div>
          </div>
