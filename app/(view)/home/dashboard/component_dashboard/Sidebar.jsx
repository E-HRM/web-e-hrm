...
const MENU = [
  ...
  },
  {
    ...
    children: [
      {
        href: "/home/laporan/laporan_mingguan",
        match: ["/home/laporan_mingguan"],
        label: "Laporan Mingguan",
      },
      {
        href: "/home/laporan/kpi",
        match: ["/home/laporan/kpi"],
        label: "KPI",
      },
    ],
  },
...
function roleAwareDashboard(menu, role) {
  return menu.map((item) => {
    ...
    return role === "OPERASIONAL"
      ? {
          ...item,
          href: "/home/dashboard-operasional",
          match: ["/home/dashboard-operasional"],
        }
        ...
        <ul className="space-y-1">
          {MENU_FOR_ROLE.map((m) => {
            ...
            if (m.children?.length) {
              ...
              const displayOpen =
                (openSections[key] ?? anyChildActive) === true;
