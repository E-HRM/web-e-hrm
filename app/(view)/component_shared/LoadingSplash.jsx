...
export default function LoadingSplash({ fullscreen = false, label = 'Memuat data…', size = 112, brand = '#003A6F' }) {
  return (
    <div
    ...
    >
      ...
      <style jsx>{`
        ...
        .fullscreen {
          position: fixed;
          inset: 0;
          background: radial-gradient(1200px 600px at 50% -10%, ${brand}0d, transparent 60%), radial-gradient(800px 400px at -10% 110%, ${brand}0a, transparent 60%), #ffffff;
          z-index: 50;
        }
        .logoWrap {
          position: relative;
        ...
        /* pastikan wrapper AppImage tidak nambah styling yang mengganggu */
        :global(.logoImgWrap) {
          position: relative;
          display: grid;
          place-items: center;
